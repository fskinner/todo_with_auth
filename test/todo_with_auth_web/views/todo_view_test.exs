defmodule TodoWithAuthWeb.TodoViewTest do
  ...
  test "renders todo.json" do
    todo = insert(:todo)
    rendered_todo = render(TodoWithAuthWeb.TodoView, "todo.json", todo: todo)
  ...
  test "renders index.json" do
    todo = insert(:todo)
    rendered_todo = render(TodoWithAuthWeb.TodoView, "index.json", %{todos: [todo]})
  ...
  test "renders show.json" do
    todo = insert(:todo)
    rendered_todo = render(TodoWithAuthWeb.TodoView, "show.json", %{todo: todo})
